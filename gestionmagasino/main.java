...
public class main {
    public static void main(String[] args) {
        ...
        vendeur vendeur1 = new vendeur(15, 456, "yassine", "gabes", 150);
        responsable responsable1 = new responsable(400, 789, "youssef", "touzeur", 140);

        caisse caissier2 = new caisse(2, 147, "mohamed", "bouzid", 80);
        vendeur vendeur2 = new vendeur(20, 258, "hasna", "jelma", 180);
